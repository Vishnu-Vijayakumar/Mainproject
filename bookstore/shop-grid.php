                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="img/product/discount/p1.jpg">
                                            <div class="product__discount__percent">-16%</div>
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Arts Books</span>
                                            <h5><a href="#">Geography Of India</a></h5>
                                            <div class="product__item__price">Rs.695<span>Rs.825</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="img/product/discount/p2.jpg">
                                            <div class="product__discount__percent">-7%</div>
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Civil Services Exams</span>
                                            <h5><a href="#">Indian Polity 5th Edition</a></h5>
                                            <div class="product__item__price">Rs. 871  <span>Rs. 940</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="img/product/discount/p3.jpg">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Civil Services Exams</span>
                                            <h5><a href="#">Indian Art and Culture</a></h5>
                                            <div class="product__item__price">Rs. 649 <span> Rs. 825</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="img/product/discount/p4.jpg">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Civil Services Exams </span>
                                            <h5><a href="#">Governance in India </a></h5>
                                            <div class="product__item__price">Rs. 454 <span>Rs. 555</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="img/product/discount/p5.jpg">
                                            <div class="product__discount__percent">-22%</div>
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Civil Services Exams</span>
                                            <h5><a href="#">A Brief History of Modern India</a></h5>
                                            <div class="product__item__price">Rs. 274 <span>Rs. 350</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="img/product/discount/p6.jpg">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>Civil Services Exams</span>
                                            <h5><a href="#">Challenges to Internal Security of India</a></h5>
                                            <div class="product__item__price">Rs. 276 <span>Rs. 310</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">An Introduction To Political Theory 9th Edition </a></h6>
                                    <h5>Rs. 280 </h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">The Casebook Of Sherlock Holmes</a></h6>
                                    <h5>Rs.250</h5>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Essential Sociology Second Edition </a></h6>
                                    <h5>Rs. 449</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Agnipath : AGNIVEER MR - Indian Navy Exam Guide</a></h6>
                                    <h5>Rs. 155 </h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Who is a sister?</a></h6>
                                    <h5>Rs. 165</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">TALES FROM MY HEART</a></h6>
                                    <h5>Rs. 199	</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="img/product/p9.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">Quidditch Through the Ages</a></h6>
                                    <h5>Rs. 275</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="img/product/p10.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">At School with Ruskin Bond</a></h6>
                                    <h5>Rs. 219</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="img/product/p11.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="img/product/p12.jpg">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#">The Ikigai Journey</a></h6>
                                    <h5>Rs. 205</h5>
                                </div>
                            </div>
                        </div>
