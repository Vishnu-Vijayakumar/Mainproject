...
?>
                                ...
                                <input type="number"  class="form-control" name="price1"min="20"required pattern='/^(0|[1-9]\d*)(\.\d{2})?$/'>
                                </div>


                                
                                <div class="col-md-4 form-group">
                                    <label for="price2">Discount % </label>
                                <input type="number"  class="form-control" name="discount" required pattern='/^(0|[1-9]\d*)(\.\d{2})?$/'min="2"max="200">
                                </div>
...
<script>
  <?php
   ...
   if(isset($_SESSION['stat']))
	...
	?>
	  alertify.set('notifier','position', 'top-center');
       alertify.success('<?= $_SESSION['stat'];?>');
   	   <?php
	   unset($_SESSION['stat']);
      }
      ?>
