 ...
 <?php
    ...
    if(isset($_POST['submit'])){
        ...
        $book_img=$_FILES["pimage"]["name"];
        $targetImage = $targetDir . $book_img;
        $finaltargetImage = $finalpath . $book_img;

        $book_name = $_POST['pname'];
        $book_author=$_POST['p_name'];
        $book_price = $_POST['pprice'];
        $category_id = $_POST['poffer'];
        $book_language=$_POST['pfeature'];
        $book_img=$_FILES["pimage"]["name"];
        

	      echo $book_img;
        $book_img = $_POST['pimage'];
        print_r($_FILES);
        ...
        $insert = mysqli_query($conn,"INSERT INTO tbl_bookinfo VALUES (null, $category_id, '$book_name', 1, '$pimg', 'Available', $book_price, 'English', 2012, 'Raj', 1, 'Doctor')");
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
 ...
 <input type="text" name="p_name" id="pName" autofocus="false" autocomplete="off" class="form-control"  placeholder="Enter Author Name" required> <br>
 ...
 <input type="text" name="pfeature" id="pFeature" autofocus="false" autocomplete="off" class="form-control"  placeholder="Enter Book Language" required> <br>
