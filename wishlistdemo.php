            ...
            <ul>
                ...
                <li><a href="#">Pages</a>
                    <ul class="header__menu__dropdown">
                        <li><a href="./shop-details.html">Book Library</a></li>
...
<div class="container text-white">
    ...
    <section id="content">
		<div class="content-blog content-account">
			...
			<br>
			<table class="cart-table account-table table table-bordered bg-white text-dark" id="wish_table">
				<thead>
					<tr>
						<th>Book Name</th>
						<th>Price</th>
 			...
 			?>
					<tr>
                        ...
                        <a href="shop-details.php?id=<?php echo $row["book_id"] ?>">
                        	<?php echo $row["book_name"] ?></a>
						...
						<td>
							<a href="delete-wishlist.php?bookid=<?php echo $row["book_id"] ?>&loginid=<?php echo $_SESSION['user_emailid'] ?>">Delete</a> 
