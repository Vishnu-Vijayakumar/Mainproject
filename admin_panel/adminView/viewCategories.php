...
<div >
  ...
  <table class="table ">
    ...
    <?php
      ...
      $sql="SELECT * from tbl_category where category_enable=1";
    ...
    <tr>
      ...
      <td><button class="btn btn-danger" style="height:40px" onclick="categoryDelete('<?php echo $row['category_id']; ?>')">Delete</button></td>
      </tr>
      <?php
            $count=$count+1;
          }
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="c_status" required>
            </div>
            <div class="form-group">
